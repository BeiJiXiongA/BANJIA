...
- (id) initWithTitle:(NSString *)title atIndex:(NSInteger)aIndex editable:(BOOL)removable andSize:(CGSize)size
{
    ...
    if (self) {
        ...
        UILabel *titleLabel  = [[UILabel alloc] initWithFrame:CGRectMake(-4, 48, 54, 12)];
