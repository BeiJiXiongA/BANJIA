//
//  ShowDetailImageViewController.h
//  HtmlDemo
//
...
@class ShowDetailImageViewController;

@protocol ShowDetailImageViewControllerDelegate <NSObject>
@optional
 ...
 */
- (void)showDetailImageViewControllerDidAppear:(ShowDetailImageViewController *)showDetailImageViewController;
 ...
 */
- (void)showDetailImageViewControllerDidDisappear:(ShowDetailImageViewController *)showDetailImageViewController;
 ...
 */
- (void)showDetailImageViewController:(ShowDetailImageViewController *)showDetailImageViewController didFinishLoadingImage:(UIImage *)image;
 ...
 */
- (void)showDetailImageViewController:(ShowDetailImageViewController *)showDetailImageViewController didFailLoadingImageWithError:(NSError *)error;

@end

@interface ShowDetailImageViewController : UIViewController <UIGestureRecognizerDelegate>
...
@property (nonatomic, weak) id<ShowDetailImageViewControllerDelegate> delegate;
